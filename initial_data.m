...
General = struct();
General.Type = 'Two spool turbofan Engine';
General.NozzleType = 'Convergent';
General.IntakeEfficiency = 0.99;       % Isentropic
General.MechanicalEfficiency = 0.99;
General.CombustorPressureRatio = 0.96;
General.NozzleEfficiency = 0.99;
General.AmbientTemp = 220;             % Kelvin
General.Altitude = 10668;              % meters
General.MachNumber = 0.78;
General.AmbientPressure = 23842;       % Pa
General.GasConstant = 287;             % J/kg K
General.FuelLHV = 43e6;                % J/kg (converted from 43 MJ)
General.CpAir = 1000;
General.KappaAir = 1.4;
General.CpGas = 1150;
General.KappaGas = 1.33;